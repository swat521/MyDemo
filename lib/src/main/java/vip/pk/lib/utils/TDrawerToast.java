...
public class TDrawerToast{
	 ...
	 * 单例
	 */
	private static TDrawerToast instance;
	 ...
	 * @return
	 */
	public static TDrawerToast getInstance(Context context){
		if(instance == null){
			instance = new TDrawerToast(context);
		}
		return instance;
	}
	
	private TDrawerToast(Context context){
