...
public class YzmHuadongDemo  extends BaseActivity {
    ...
    public void initView() {
        setContentView(R.layout.yzm_huadong);
        ...
        captcha.setCaptchaListener(new Captcha.CaptchaListener() {
            ...
            public String onAccess(long time) {
                Toast.makeText(YzmHuadongDemo.this, "验证成功", Toast.LENGTH_SHORT).show();
                return "验证通过";
            }

            @Override
            public String onFailed(int count) {
                Toast.makeText(YzmHuadongDemo.this, "验证失败,失败次数" + count, Toast.LENGTH_SHORT).show();
                return "验证失败";
            }

            @Override
            public String onMaxFailed() {
                Toast.makeText(YzmHuadongDemo.this, "验证超过次数，你的帐号被封锁", Toast.LENGTH_SHORT).show();
                return "可以走了";
            }
