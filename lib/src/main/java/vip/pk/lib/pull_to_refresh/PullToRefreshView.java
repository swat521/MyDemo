...
public class PullToRefreshView extends LinearLayout implements OnScrollListener {
     ...
     * 下拉刷新是否可用
     */
    private boolean header_fresh = true;
    /*
     * 上拉更多是否可用
     */
    private boolean footer_fresh = true;
    /**
     * header view
     */
    ...
    public void set_enable_header_refresh(boolean enable_true) {
        this.header_fresh = enable_true;
    }

    public void set_enable_footer_refresh(boolean enable_true) {
        this.footer_fresh = enable_true;
    }
    ...
    private void init() {
		...
		*/
		/*	Context c = getContext();
				...
				ImageView mImageView = new ImageView(c);  
				mImageView.setImageResource(R.drawable.no_data); 
				
				RelativeLayout.LayoutParams lp2 = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT,RelativeLayout.LayoutParams.WRAP_CONTENT);
				rl.setLayoutParams(lp2);
				lp2.addRule(RelativeLayout.CENTER_HORIZONTAL, 1);
				lp2.addRule(RelativeLayout.CENTER_VERTICAL, 1);
    ...
    private void addHeaderView() {
        ...
        LayoutParams params = new LayoutParams(LayoutParams.FILL_PARENT, //MATCH_PARENT
                mHeaderViewHeight);
     ...
     * @return
     */
    private boolean isRefreshViewScroll(int deltaY) {//// deltaY > 0 是向下运动,< 0是向上运动
    ...
    public void onHeaderRefreshComplete() {
        ...
        mHeaderImageView.setImageResource(R.mipmap.pull_to_refresh_arrow_down);
        mHeaderTextView.setText("下拉刷新");
    ...
    public void onFooterRefreshComplete() {
        ...
        mFooterImageView.setImageResource(R.mipmap.pull_to_refresh_arrow_up);
        mFooterTextView.setText("上拉加载更多");
    ...
    public void onScrollStateChanged(AbsListView arg0, int arg1) {
        // TODO Auto-generated method stub
        if (mAdapterView.getLastVisiblePosition() == (mAdapterView.getCount() - 1) && arg1 == OnScrollListener.SCROLL_STATE_IDLE) {
            //Toast.makeText(arg0.getContext(), "加载中", Toast.LENGTH_SHORT);
            if (footer_fresh) {
                footerRefreshing();
            }
        }
