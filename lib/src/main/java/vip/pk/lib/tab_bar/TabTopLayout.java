...
public class TabTopLayout extends LinearLayout {
    ...
    //private CharSequence[] toptab_Titles = {"标准","卫星","路况"};
    ...
    public void setData( CharSequence[] toptab_Titles,int paddingLeft,int paddingRight,int paddingTop,int paddingBottom){
        ...
        initAddBottomTabItemView(tab_titleList, paddingLeft, paddingRight, paddingTop, paddingBottom);
    }

    //初始化控件
    private void initAddBottomTabItemView(List<CharSequence> tabTitleList,int paddingLeft,int paddingRight,int paddingTop,int paddingBottom){
        ...
        for(int index=0;index<tabTitleList.size();index++){
            ...
            toptab_checkedTextView.setPadding(paddingLeft,paddingTop,paddingRight,paddingBottom);
